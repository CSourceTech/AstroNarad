...
const TopAstrologers = () => {
    ...
    const navigate_to_AstroDesc = (name, about, experience, type, language_known, rating, id, charge, total_time_spent_on_message, total_time_spent_on_call) => {
      navigation.navigate('AstrologerDesc', { astrologerName: name, info: about, exp: experience, expert: type, lang: language_known, Rating: rating, Id: id , cost: charge, on_Chat: total_time_spent_on_message, on_Call: total_time_spent_on_call});
    };
          ...
          {astrologers.map((astrologer) => (
            ...
            >
              ...
              <View style={styles.AstrologersDetails}>
                ...
                {/* <Text style={styles.Duration}>₹{astrologer.id}</Text> */}
              </View>
            </TouchableOpacity>
          ))}
        </View>
